...
import type { TransactionRecentRequest, TransactionRecentResponse } from '../models';
...
export declare class StreamApi extends runtime.BaseAPI {
     ...
     */
    transactionRecentRaw(requestParameters: TransactionRecentOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TransactionRecentResponse>>;
    /**
     * Returns user-initiated transactions which have been committed to the ledger. The returned response is in a paginated format, ordered by most recently committed.
     * Get Recent Transactions
     */
    transactionRecent(requestParameters: TransactionRecentOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TransactionRecentResponse>;
}
