...
import type { TransactionCommittedDetailsRequest, TransactionCommittedDetailsResponse, TransactionConstructionResponse, TransactionStatusRequest, TransactionStatusResponse, TransactionSubmitRequest, TransactionSubmitResponse } from '../models';
...
export declare class TransactionApi extends runtime.BaseAPI {
     ...
     * Preview Transaction
     */
    transactionPreviewRaw(requestParameters: TransactionPreviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>>;
    /**
     * Previews transaction against the network. This endpoint is effectively a proxy towards CoreApi\'s `/v0/transaction/preview` endpoint. See CoreApi\'s documentation for more details.
     * Preview Transaction
     */
    transactionPreview(requestParameters: TransactionPreviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object>;
    /**
