...
import type { GatewayInformationResponse } from '../models';
/**
 *
 */
export declare class StatusApi extends runtime.BaseAPI {
     ...
     */
    gatewayInformationRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GatewayInformationResponse>>;
    /**
     * Returns the Gateway API version, current ledger state and well-known network addresses.
     * Get Gateway Information
     */
    gatewayInformation(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GatewayInformationResponse>;
}
