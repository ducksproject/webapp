 ...
 */
export declare function instanceOfEntityNonFungibleIdsResponseAllOf(value: object): boolean;
export declare function EntityNonFungibleIdsResponseAllOfFromJSON(json: any): EntityNonFungibleIdsResponseAllOf;
export declare function EntityNonFungibleIdsResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityNonFungibleIdsResponseAllOf;
export declare function EntityNonFungibleIdsResponseAllOfToJSON(value?: EntityNonFungibleIdsResponseAllOf | null): any;
