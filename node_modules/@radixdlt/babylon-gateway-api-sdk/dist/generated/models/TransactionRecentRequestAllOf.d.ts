 ...
 */
export declare function instanceOfTransactionRecentRequestAllOf(value: object): boolean;
export declare function TransactionRecentRequestAllOfFromJSON(json: any): TransactionRecentRequestAllOf;
export declare function TransactionRecentRequestAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionRecentRequestAllOf;
export declare function TransactionRecentRequestAllOfToJSON(value?: TransactionRecentRequestAllOf | null): any;
