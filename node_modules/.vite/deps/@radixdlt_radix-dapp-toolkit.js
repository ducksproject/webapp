...
function mt(t) {
  if (rn.useDeprecatedSynchronousErrorHandling) {
    var e = !ft;
    if (e && (ft = { errorThrown: false, error: null }), t(), e) {
...
var on = function(t) {
  ...
  function e(n) {
    ...
    return r.isStopped = false, n ? (r.destination = n, tr(n) && n.add(r)) : r.destination = gi, r;
  }
...
function Yi(t, e, n, r, i, o, s, a) {
  var c = [], u = 0, l = 0, p = false, f = function() {
...
var Gi = ["addListener", "removeListener"];
var Qi = ["addEventListener", "removeEventListener"];
var Xi = ["on", "off"];
function Pe(t, e, n, r) {
...
function oo(t, e, n, r, i) {
  return function(o, s) {
    ...
    o.subscribe(V(s, function(l) {
      var p = u++;
      c = a ? t(c, l, p) : (a = true, l), r && s.next(c);
    }, i && function() {
...
function uo(t, e) {
  return G(oo(t, e, arguments.length >= 2, true));
}
function br(t) {
  t === void 0 && (t = {});
  var e = t.connector, n = e === void 0 ? function() {
    return new ue();
  } : e, r = t.resetOnError, i = r === void 0 ? true : r, o = t.resetOnComplete, s = o === void 0 ? true : o, a = t.resetOnRefCountZero, c = a === void 0 ? true : a;
  return function(u) {
    var l, p, f, h = 0, g = false, d = false, _ = function() {
      p == null || p.unsubscribe(), p = void 0;
    }, x = function() {
      _(), l = f = void 0, g = d = false;
    }, m = function() {
      var D = l;
    ...
    return G(function(D, Z) {
      ...
      Z.add(function() {
        ...
        error: function(y) {
          d = true, _(), p = Pt(x, i, y), W.error(y);
        },
        complete: function() {
          g = true, _(), p = Pt(x, s), W.complete();
        }
      }), Q(D).subscribe(l));
    })(u);
  };
...
function co(t, e, n) {
  var r, i, o, s, a = false;
  return t && typeof t == "object" ? (r = t.bufferSize, s = r === void 0 ? 1 / 0 : r, i = t.windowTime, e = i === void 0 ? 1 / 0 : i, o = t.refCount, a = o === void 0 ? false : o, n = t.scheduler) : s = t ?? 1 / 0, br({
    connector: function() {
      return new Ie(s, e, n);
    },
    resetOnError: true,
...
function lo() {
  ...
  return G(function(r, i) {
    for (var o = t.length, s = new Array(o), a = t.map(function() {
      return false;
    }), c = false, u = function(p) {
      Q(t[p]).subscribe(V(i, function(f) {
        s[p] = f, !c && !a[p] && (a[p] = true, (c = a.every(lt)) && (a = null));
      }, Ft));
    }, l = 0; l < o; l++)
      u(l);
...
var mo = function(t) {
  return function(e) {
    return je(je([], yt(e), false), [t], false);
  };
};
var _r = function(t) {
...
var xr = function(t) {
  return t.reduce(function(e, n) {
    return n.isErr() ? e.isErr() ? ce(je(je([], yt(e.error), false), [n.error], false)) : ce([n.error]) : e.isErr() ? e : ne(je(je([], yt(e.value), false), [n.value], false));
  }, ne([]));
};
var yo = function(t) {
  ...
  function e(i, o) {
    return function() {
      for (var s = [], a = 0; a < arguments.length; a++)
        s[a] = arguments[a];
      try {
        var c = i.apply(void 0, je([], yt(s), false));
        return ne(c);
      } catch (u) {
        return ce(o ? o(u) : u);
      }
...
Bt.fromThrowable;
var bo = (t, e) => e ? !t || !(e != null && e.quantity) || !(e != null && e.quantifier) ? false : e.quantifier === "exactly" ? t.length === e.quantity : t.length >= e.quantity : true;
var xn = (t, {
  state: e,
  logger: n,
  walletClient: r
  ...
  ].reduce((o, s) => o && s, true) && !t.oneTimeAccountsWithoutProofOfOwnership) {
...
var Sn = (t, e) => e.persona ? {
  ...t,
  usePersona: {
    discriminator: "usePersona",
    identityAddress: e.persona.identityAddress
  }
} : { ...t, loginWithoutChallenge: { discriminator: "login" } };
var zt = (t) => t;
var Sr = (t) => {
  try {
...
var _o = (t) => {
  const e = t.key, n = t.subjects || fo(), r = t.logger, i = t.connectButtonClient, o = t.walletClient, s = t.storageClient, a = t.useDoneCallback, c = t.onDisconnectCallback, u = new Te(), l = () => s.getData(e).map((y) => (y && (r == null || r.debug("readFromStorage")), y)), p = (y) => s.setData(e, y).map(() => {
    ...
    n.setState.next({ state: $t, persist: true });
  ...
  ).map(({ data: q, resolvedBy: S, persist: ee }) => (S === "wallet" && ee && f({ ...q, connected: K.connected }, true), q)));
  return u.add(
    i.onConnect$.pipe(
      N(() => {
      ...
      gr(([, y]) => {
        var K;
        return ((K = t.connectRequest) == null ? void 0 : K.call(t, (q) => (r == null || r.debug("connectRequest", q), i.setConnecting(true), xn(
          Sn(
            {
        ...
        ).map(({ data: S }) => (a || (f({ ...S, connected: true }, true), i.setConnecting(false)), {
          data: S,
          done: () => {
            f({ ...S, connected: true }, true), i.setConnecting(false);
          }
        })).mapErr((S) => (f({ connected: false }, true), i.setConnecting(false), S))))) ?? [];
      })
    ).subscribe()
  ), {
    connected$: _.pipe(
...
var xo = () => ({
  onConnect: new ue(),
  onDisconnect: new ue(),
  loading: new me(false),
  connected: new Ie(),
  requestItems: new me([]),
  onCancelRequestItem: new ue(),
  accounts: new me([]),
  connecting: new me(false),
  showNotification: new me(false),
  personaLabel: new me("")
});
var So = (t) => {
  import("./connect-button-e431ab55-LLEXNI2W.js");
...
var Io = (t, e, n) => e in t ? ko(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var it = (t, e, n) => (Io(t, typeof e != "symbol" ? e + "" : e, n), n);
var Kt = function(t, e) {
...
var ln = function(t) {
  ...
  function e(n) {
    var r = t.call(this) || this;
    return r.isStopped = false, n ? (r.destination = n, Er(n) && n.add(r)) : r.destination = Zo, r;
  }
  return e.create = function(n, r, i) {
    return new Qe(n, r, i);
  }, e.prototype.next = function(n) {
...
var jo = Function.prototype.bind;
function Nt(t, e) {
  return jo.call(t, e);
}
var No = function() {
...
var Ko = function(t) {
  ...
  return e.prototype.schedule = function(n, r) {
    ...
    if (!this.closed) {
      ...
      this.work = this.state = this.scheduler = null, this.pending = false, bt(o, this), r != null && (this.id = this.recycleAsyncId(i, r, null)), this.delay = null, t.prototype.unsubscribe.call(this);
    }
  }, e;
}(zo);
var An = function() {
  ...
  return function(u) {
    ...
    return X(function(D, Z) {
      ...
      Z.add(function() {
        ...
        error: function(y) {
          d = true, _(), p = Zt(x, i, y), W.error(y);
        },
        complete: function() {
          g = true, _(), p = Zt(x, s), W.complete();
        }
      }), Ee(D).subscribe(l));
    })(u);
  };
...
var xs = (t) => t.outgoingMessageSubject.pipe(
  st((e) => ({
...
(function(t) {
  (function(e, n) {
    ...
    function a(d) {
      return d === "debug" && (d = "log"), typeof console === n ? false : d === "trace" && r ? s : console[d] !== void 0 ? o(console, d) : console.log !== void 0 ? o(console, "log") : e;
    }
    function c(d, _) {
    ...
    function p(d, _, x) {
      ...
      m.name = d, m.levels = {
        ...
        if (typeof S == "string" && m.levels[S.toUpperCase()] !== void 0 && (S = m.levels[S.toUpperCase()]), typeof S == "number" && S >= 0 && S <= m.levels.SILENT) {
          if (D = S, ee !== false && W(S), c.call(m, S, d), typeof console === n && S < m.levels.SILENT)
            return "No console available for logging";
        } else
          throw "log.setLevel() called with invalid level: " + S;
      }, m.setDefaultLevel = function(S) {
        _ = S, y() || m.setLevel(S, false);
      }, m.resetLevel = function() {
        m.setLevel(_, false), K();
...
var J = Yr.exports;
var Ss = (t) => t.incomingMessageSubject.pipe(
  ze((e) => {
...
var Ts = (t) => t.dispatchEventSubject.pipe(
...
var Is = function(t) {
  return function(e) {
    return Ne(Ne([], gt(e), false), [t], false);
  };
};
var Gr = function(t) {
  return t.reduce(function(e, n) {
...
var Qr = function(t) {
  return t.reduce(function(e, n) {
    return n.isErr() ? e.isErr() ? ie(Ne(Ne([], gt(e.error), false), [n.error], false)) : ie([n.error]) : e.isErr() ? e : re(Ne(Ne([], gt(e.value), false), [n.value], false));
  }, re([]));
};
var Cs = function(t) {
  ...
  function e(i, o) {
    return function() {
      for (var s = [], a = 0; a < arguments.length; a++)
        s[a] = arguments[a];
      try {
        var c = i.apply(void 0, Ne([], gt(s), false));
        return re(c);
      } catch (u) {
        return ie(o ? o(u) : u);
      }
...
var $s = (/* @__PURE__ */ new Map()).set(Le.missingExtension, "extension could not be found").set(Le.rejectedByUser, "user rejected request").set(Le.canceledByUser, "user has canceled the request");
var wt = (t, e, n) => ({
  error: t,
  interactionId: e,
  message: n || $s.get(t) || ""
});
var js = (t) => he.fromPromise(fs(t), Rs).andThen(
  (e) => e
);
var Ns = (t, e) => t.messageLifeCycleEventSubject.pipe(
...
var Y = (t) => ({ status: "valid", value: t });
var Pn = (t) => t.status === "aborted";
var Cn = (t) => t.status === "dirty";
var Gt = (t) => t.status === "valid";
var Rn = (t) => typeof Promise !== void 0 && t instanceof Promise;
var A;
(function(t) {
...
var $n = (t, e) => {
  ...
  return { success: false, error: new ut(t.common.issues) };
};
function k(t) {
  if (!t)
    return {};
...
var R = class {
  ...
  refinement(e, n) {
    return this._refinement((r, i) => e(r) ? true : (i.addIssue(typeof n == "function" ? n(r, i) : n), false));
  }
  _refinement(e) {
    return new tt({
      schema: this,
...
var Us = /^c[^\s-]{8,}$/i;
var Ws = /^([a-f0-9]{8}-[a-f0-9]{4}-[1-5][a-f0-9]{3}-[a-f0-9]{4}-[a-f0-9]{12}|00000000-0000-0000-0000-000000000000)$/i;
var Ms = /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
...
var et = class extends R {
  ...
  gte(e, n) {
    return this.setLimit("min", e, true, A.toString(n));
  }
  gt(e, n) {
    return this.setLimit("min", e, false, A.toString(n));
  }
  lte(e, n) {
    return this.setLimit("max", e, true, A.toString(n));
  }
  lt(e, n) {
    return this.setLimit("max", e, false, A.toString(n));
  }
  setLimit(e, n, r, i) {
    return new et({
      ...this._def,
...
function en(t, e) {
  ...
  if (n === b.object && r === b.object) {
    ...
    return n === b.date && r === b.date && +t == +e ? { valid: true, data: t } : { valid: false };
}
...
var Tt = class extends R {
  _parse(e) {
    const { ctx: n } = this._processInputParams(e);
    if (n.parsedType !== b.promise && n.common.async === false)
      return w(n, {
        code: v.invalid_type,
        expected: b.promise,
        received: n.parsedType
...
var Yn = (t) => (e, n = crypto.randomUUID()) => re({
  items: e,
  interactionId: n,
  metadata: t
});
...
var Su = (t) => `"${t}"`;
var Tu = (t, ...e) => e.length > 0 ? `Enum("${t}",${e.join(",")})` : `Enum("${t}")`;
var Ou = (...t) => `Tuple(${t.join(",")})`;
var Eu = (t, ...e) => (Pa(t, e), `Array<${t}>(${e.join(",")})`);
var Ia = (t) => `PackageAddress("${t}")`;
var Ae = (t) => `ComponentAddress("${t}")`;
var U = (t) => `ResourceAddress("${t}")`;
var Au = (t) => `SystemAddress("${t}")`;
var Ue = (t) => typeof t == "string" ? `Bucket("${t}")` : `Bucket(${t}u32)`;
var ae = (t) => typeof t == "string" ? `Proof("${t}")` : `Proof(${t}u32)`;
var ku = (t) => `Expression("${t}")`;
var Iu = (t) => `Blob("${t}")`;
var Pu = (t, e) => `NonFungibleAddress("${t}", ${e})`;
var Cu = (t) => `Hash("${t}")`;
var Ru = (t) => `EcdsaSecp256k1PublicKey("${t}")`;
var $u = (t) => `EcdsaSecp256k1Signature("${t}")`;
var ju = (t) => `EddsaEd25519PublicKey("${t}")`;
var Nu = (t) => `EddsaEd25519Signature("${t}")`;
var We = (t) => `Decimal("${t}")`;
var Lu = (t) => `PreciseDecimal("${t}")`;
var Zu = (t) => `NonFungibleId(${t})`;
var Pa = (t, e) => {
  if (t === "String") {
...
var Za = typeof ot == "object" && ot && ot.Object === Object && ot;
var Da = typeof self == "object" && self && self.Object === Object && self;
var qa = Za || Da || Function("return this")();
function Ua(t, e, n) {
  switch (n.length) {
    case 0:
      return t.call(e);
...
var Ma = mn.hasOwnProperty;
var fi = mn.toString;
var Jn = qa.Symbol;
var Fa = mn.propertyIsEnumerable;
var Gn = Jn ? Jn.isConcatSpreadable : void 0;
var Qn = Math.max;
...
var Wu = ({ dAppDefinitionAddress: t, dAppName: e }, n, r) => {
  const {
    networkId: i = 1,
    providers: o,
    logger: s,
