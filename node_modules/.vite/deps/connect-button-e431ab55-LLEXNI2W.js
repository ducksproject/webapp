...
var createMarker = (v2 = "") => d.createComment(v2);
...
// node_modules/@radixdlt/radix-dapp-toolkit/dist/connect-button-e431ab55.mjs
var at = {
...
var Dt = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? xt(e, n) : e, i = t.length - 1, a; i >= 0; i--)
...
var ht = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Nt(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
...
A.styles = css`
    ...
    button.gradient {
      background: url(${unsafeCSS(At)}) no-repeat;
...
var X = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Ot(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
...
], j.prototype, "transactionExplorerBaseUrl", 2);
X([
  state()
], j.prototype, "features", 2);
j = X([
...
function Ct(t, e, n) {
  ...
  function s(M) {
    M.value instanceof I ? Promise.resolve(M.value.v).then(c, l) : m(i[0][2], M);
  }
  function c(M) {
    u("next", M);
  }
        ...
        try {
          for (var M = Z(m), b = M.next(); !b.done; b = M.next()) {
            ...
            try {
              ...
              i = i ?? [], p instanceof k ? i = W(W([], L(i)), L(p.errors)) : i.push(p);
            }
          }
        } catch (p) {
          r = { error: p };
...
var q = function(t) {
  ...
  function e(n) {
    ...
    return r.isStopped = false, n ? (r.destination = n, st(n) && n.add(r)) : r.destination = Jt, r;
  }
...
var Ht = Function.prototype.bind;
function Q(t, e) {
  return Ht.call(t, e);
}
var Vt = function() {
...
var J = function(t) {
  ...
  function e(n, r, o) {
    ...
    return i.destination = new Vt(a), i;
  }
  return e;
}(q);
function S(t) {
...
var v = function() {
  ...
  return t.prototype.lift = function(e) {
    ...
    var o = this, i = qt(e) ? e : new J(e, n, r);
    return Qt(function() {
...
function qt(t) {
  return t && t instanceof q || Ft(t) && st(t);
}
function Kt(t) {
    ...
    return ct(this, function(i) {
      switch (i.label) {
        ...
        case 2:
          return [4, I(e.read())];
        case 3:
          return n = i.sent(), r = n.value, o = n.done, o ? [4, I(void 0)] : [3, 5];
        case 4:
          return [2, i.sent()];
        case 5:
          return [4, I(r)];
...
function ge(t, e) {
  ...
  return Xt(this, void 0, void 0, function() {
    ...
    return ct(this, function(s) {
      switch (s.label) {
        case 0:
          s.trys.push([0, 5, 6, 11]), n = Yt(t), s.label = 1;
        case 1:
          return [4, n.next()];
        case 2:
          if (r = s.sent(), !!r.done)
...
function be(t, e) {
  return fe(e) ? t.apply(void 0, W([], L(e))) : t(e);
}
function ye(t) {
...
function me(t, e, n, r, o, i, a, u) {
  var s = [], c = 0, l = 0, m = false, M = function() {
    m && !s.length && !c && e.complete();
  }, b = function(p) {
    return c < r ? D(p) : s.push(p);
  }, D = function(p) {
    i && e.next(p), c++;
    var _ = false;
    $(n(p, l++)).subscribe(O(e, function(T) {
...
var xe = ["addListener", "removeListener"];
var De = ["addEventListener", "removeEventListener"];
var ze = ["on", "off"];
function R(t, e, n, r) {
  if (d2(n) && (r = n, n = void 0), r)
    return R(t, e, n).pipe(ye(r));
  var o = L(Ae(t) ? De.map(function(u) {
    return function(s) {
      return t[u](e, s, n);
    };
  }) : Ne(t) ? xe.map(it(t, e)) : he(t) ? ze.map(it(t, e)) : [], 2), i = o[0], a = o[1];
  if (!i && Mt(t))
...
var x = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? je(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && Ie(e, n, o), o;
};
var y = class extends LitElement {
  constructor() {
    super(), this.connected = false, this.loading = false, this.showNotification = false, this.showPopover = false, this.connecting = false, this.requestItems = [], this.accounts = [], this.explorer = {
  ...
  disconnectWalletTemplate() {
    return this.connected ? html`<div class="wrapper disconnect-wallet">
        <radix-button
  ...
  personaTemplate() {
    return this.personaLabel && this.connected ? html`<div class="wrapper persona">
...
lit-html/development/directives/class-map.js:
   ...
   *)
*/
//# sourceMappingURL=connect-button-e431ab55-LLEXNI2W.js.map
